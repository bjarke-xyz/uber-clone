...
type AuthClient interface {
	ValidateToken(ctx context.Context, in *ValidateTokenRequest, opts ...grpc.CallOption) (*AuthToken, error)
}
...
func (c *authClient) ValidateToken(ctx context.Context, in *ValidateTokenRequest, opts ...grpc.CallOption) (*AuthToken, error) {
	out := new(AuthToken)
...
type AuthServer interface {
	ValidateToken(context.Context, *ValidateTokenRequest) (*AuthToken, error)
...
func (UnimplementedAuthServer) ValidateToken(context.Context, *ValidateTokenRequest) (*AuthToken, error) {
